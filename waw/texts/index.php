<? include_once('../templates/header.php'); ?>
        <link href="../css/text_item.css" rel="stylesheet" />
        <div id='container'>
        	<? include_once('../templates/nav_bar.php'); ?>
            <div id='inner_container'>
            	<div id='text_item_title_text'>PhoneGap (Cordova)</div>
	            <div id='text_item_middle_container'>
	            	<div id='text_item_info_container'>
		            	<div class='text_item_info_entry'>
		        				...
		        				<div class='text_item_info_value'>Mobile Dev</div>
		        			</div>
		        			<div class='text_item_info_entry'>
		        				<div class='text_item_info_title'>- Date:</div>
		        				<div class='text_item_info_value'>Jun, 27, 2012</div>
		        			</div>

		        		</div>
	            	<div id='text_item_image_container'>
		            	<img src='PhoneGap/images/cordova.png' />
	            	</div>

	            </div>
	            <div id='text_item_text_container'>
